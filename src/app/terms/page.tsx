...
const copyByLocale: Record<Locale, TermsCopy> = {
  ...
  "zh-Hans": {
    ...
    sections: [
      { title: "使用慧享", body: "慧享是一项用于录制和分享个人故事的服务。请依法使用，并确保录音中所有声音或个人信息的相关人士都已同意。" },
      ...
      { title: "账户与服务可用性", body: "请妥善保管账户凭证。如果您认为有人未经许可访问了您的账户，请立即通知我们。为了运营、保护或改善服务，慧享可能在必要时更改、暂停或停止某些功能。" },
      { title: "联系与条款变更", body: "如对本条款有疑问，请联系邀请您使用慧享的机构。我们可能不时更新本条款，并将更新后的版本发布在本页面。" },
    ],
  },
  "zh-Hant": {
    eyebrow: "法律資訊", title: "使用條款", effective: "生效日期：2026 年 7 月 27 日",
    sections: [
      { title: "使用慧享", body: "慧享是一項用於錄製和分享個人故事的服務。請合法使用，並確保錄音中所有聲音或個人資料的相關人士都已同意。" },
      ...
      { title: "帳戶與服務可用性", body: "請妥善保管帳戶憑證。如果您認為有人未經許可存取您的帳戶，請立即通知我們。為了營運、保護或改善服務，慧享可能在必要時更改、暫停或停止某些功能。" },
      { title: "聯絡與條款變更", body: "如對本條款有疑問，請聯絡邀請您使用慧享的機構。我們可能不時更新本條款，並將更新後的版本發布在本頁。" },
    ],
  },
};
