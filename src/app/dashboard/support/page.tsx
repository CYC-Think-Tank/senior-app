...
const copy: Record<Locale, {
  ...
  "zh-Hans": {
    eyebrow: "仁慧享 AI · 陪伴与人工支持",
    title: "说出需要，就能找到帮助。",
    intro: "告诉仁慧享您需要什么。我们会了解需求，把敏感事项交给受过培训的员工，并寻找合适的人来协助。",
    safety: "如遇紧急情况，请拨打 911。仁慧享请求不会被实时监控。",
    howTitle: "安全连接人工支持",
    steps: [
      { title: "了解需求", body: "AI 会识别帮助类型、语言、时间、所需技能和紧急程度。" },
      { title: "安全匹配", body: "安全检查会判断应由学生、付费助手还是受训员工提供帮助。" },
      { title: "持续跟进", body: "仁慧享会确认介绍、了解问题是否解决，并在需要时升级处理。" },
    ],
  },
  "zh-Hant": {
    eyebrow: "仁慧享 AI · 陪伴與人工支援",
    title: "說出需要，就能找到協助。",
    intro: "告訴仁慧享您需要甚麼。我們會了解需要，把敏感事項交給受過培訓的職員，並尋找合適的人協助。",
    safety: "如遇緊急情況，請致電 911。仁慧享請求不會被即時監察。",
    howTitle: "安全連接人工支援",
    steps: [
      { title: "了解需要", body: "AI 會識別協助類型、語言、時間、所需技能和緊急程度。" },
      { title: "安全配對", body: "安全檢查會判斷應由學生、付費助手還是受訓職員提供協助。" },
      { title: "持續跟進", body: "仁慧享會確認介紹、了解問題是否解決，並在需要時升級處理。" },
    ],
  },
};
