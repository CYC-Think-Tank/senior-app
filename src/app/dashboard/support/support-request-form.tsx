...
const copy = {
  ...
  "zh-Hans": {
    ...
    emergencyBody: "慧享不是紧急服务，此请求不会被实时监控。如果您或他人可能有危险，请立即拨打 911。",
    staffTitle: "需要受过培训的慧享员工",
    staffBody: "此需求可能涉及敏感信息或较高风险的决定，因此不会交给学生志愿者。工作人员会进行审核。",
    matchedTitle: "我们找到了一位合适的人选",
    openTitle: "您的需求已进入匹配队列",
    openBody: "当前人员名单中还没有合适的人选。慧享工作人员会审核并协助联系。",
    match: "匹配度",
    available: "时间",
    skills: "可以协助",
    newRequest: "提出其他需求",
    next: "您愿意联系吗？在分享任何联系方式之前，慧享工作人员会先确认介绍。",
    error: "出了点问题，请重试。",
  },
  "zh-Hant": {
    ...
    emergencyBody: "慧享並非緊急服務，此請求不會被即時監察。如果您或他人可能有危險，請立即致電 911。",
    staffTitle: "需要受過培訓的慧享職員",
    staffBody: "此需要可能涉及敏感資料或較高風險的決定，因此不會交給學生義工。職員會進行審核。",
    matchedTitle: "我們找到了一位合適人選",
    openTitle: "您的需要已進入配對隊列",
    openBody: "目前名單中還沒有合適人選。慧享職員會審核並協助聯絡。",
    match: "配對度",
    available: "時間",
    skills: "可以協助",
    newRequest: "提出其他需要",
    next: "您願意聯絡嗎？在分享任何聯絡資料前，慧享職員會先確認介紹。",
    error: "發生問題，請再試一次。",
  },
...
function providerLabel(type: ProviderType, locale: Locale) {
  const labels: Record<Locale, Record<ProviderType, string>> = {
    ...
    "zh-Hans": { high_school: "高中生志愿者", college: "大学生", staff: "受过培训的慧享员工" },
    "zh-Hant": { high_school: "高中生義工", college: "大專或大學生", staff: "受過培訓的慧享職員" },
  };
