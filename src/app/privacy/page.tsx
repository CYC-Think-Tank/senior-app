  ...
  return (
    <main className={styles.page}>
      <div className={styles.shell}>
        <Link className={styles.home} href="/">← WiseShare</Link>
        ...
        <article className={styles.content}>
          <section>
            ...
            <p>
              WiseShare helps people record conversations and turn them into audio memoirs. This policy explains how we handle personal information when you use WiseShare.
            </p>
          </section>
          <section>
          ...
          <section>
            ...
            <p>
              We use service providers to operate WiseShare, including Supabase for authentication, databases, and file storage; OpenAI for AI interview features; and Resend for invitation and account emails. They process information only as needed to provide their services to us.
            </p>
          </section>
          <section>
            <h2>Retention and security</h2>
            <p>
              We keep information for as long as it is needed to provide WiseShare, meet legal obligations, resolve disputes, and enforce agreements. Unfinished public interviews are normally deleted after about 24 hours. We use reasonable safeguards appropriate to the sensitivity of the information, but no online service can guarantee absolute security.
            </p>
          </section>
          <section>
            <h2>Your choices</h2>
          ...
          <section>
            ...
            <p>
              We may update this policy as WiseShare changes. We will post the updated version here and revise the effective date.
            </p>
          </section>
        </article>
      </div>
