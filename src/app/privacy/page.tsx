...
const copyByLocale: Record<Locale, PrivacyCopy> = {
  en: {
    ...
    sections: [
      ...
      { title: "Service providers", body: "We use service providers to operate WiseShare, including Microsoft Azure for databases and file storage; Vercel for hosting; OpenAI for AI interview features; and Resend for account emails. They process information only as needed to provide their services to us." },
  ...
  "zh-Hans": {
    ...
    sections: [
      ...
      { title: "服务提供商", body: "我们使用服务提供商来运营慧享，包括用于数据库和文件存储的 Microsoft Azure，用于托管的 Vercel，用于 AI 访谈功能的 OpenAI，以及用于账户邮件的 Resend。这些服务商仅在为我们提供服务所需的范围内处理信息。" },
  ...
  "zh-Hant": {
    ...
    sections: [
      ...
      { title: "服務供應商", body: "我們使用服務供應商來營運慧享，包括用於資料庫和檔案儲存的 Microsoft Azure，用於託管的 Vercel，用於 AI 訪談功能的 OpenAI，以及用於帳戶郵件的 Resend。這些供應商只會在向我們提供服務所需的範圍內處理資料。" },
